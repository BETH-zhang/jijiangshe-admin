...
!(function(e) {
      ...
      for (e = e.replace(/^ +$/gm, ''); e; )
        if (
          ...
          for (
            e = e.substring(i[0].length),
              g = (l = i[2]).length > 1,
              this.tokens.push({ type: 'list_start', ordered: g, start: g ? +l : '' }),
              r = !1,
          ...
          for (p = 0; p < a.cells.length; p++)
            a.cells[p] = b(a.cells[p].replace(/^ *\| *| *\| *$/g, ''), a.header.length);
          this.tokens.push(a);
  ...
  function s(e, t) {
    ...
    this.options.pedantic
      ...
      : this.options.gfm && (this.options.breaks ? (this.rules = r.breaks) : (this.rules = r.gfm));
  }
  function i(e) {
    this.options = e || m.defaults;
  }
    ...
    return (
      ...
      (t = t || ''),
      {
        replace: function(t, n) {
          return (
            (n = (n = n.source || n).replace(/(^|[^\[])\^/g, '$1')), (e = e.replace(t, n)), this
          );
        },
        getRegex: function() {
  ...
  (r._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (s.prototype.output = function(e) {
      for (var t, n, r, i, l, o = ''; e; )
        if ((l = this.rules.escape.exec(e))) (e = e.substring(l[0].length)), (o += l[1]);
          ...
          if ((l = this.rules.tag.exec(e)))
            ...
            (e = e.substring(l[0].length)),
              ...
              (o += this.outputLink(l, { href: s.escapes(r), title: s.escapes(i) })),
              (this.inLink = !1);
            ...
            (e = e.substring(l[0].length)),
              (o += this.renderer.strong(this.output(l[4] || l[3] || l[2] || l[1])));
          else if ((l = this.rules.em.exec(e)))
            (e = e.substring(l[0].length)),
              (o += this.renderer.em(this.output(l[6] || l[5] || l[4] || l[3] || l[2] || l[1])));
          else if ((l = this.rules.code.exec(e)))
            (e = e.substring(l[0].length)), (o += this.renderer.codespan(a(l[2].trim(), !0)));
          else if ((l = this.rules.br.exec(e)))
            (e = e.substring(l[0].length)), (o += this.renderer.br());
          else if ((l = this.rules.del.exec(e)))
            (e = e.substring(l[0].length)), (o += this.renderer.del(this.output(l[1])));
          else if ((l = this.rules.text.exec(e)))
            (e = e.substring(l[0].length)), (o += this.renderer.text(a(this.smartypants(l[0]))));
          else if (e) throw new Error('Infinite loop on byte: ' + e.charCodeAt(0));
        } else
    ...
    (o.prototype.parse = function(e) {
      (this.inline = new s(e.links, this.options)),
        (this.inlineText = new s(e.links, f({}, this.options, { renderer: new l() }))),
    ...
    if (r || 'function' == typeof t) {
      ...
      try {
        ...
        if (
          ...
          return '<p>An error occurred:</p><pre>' + a(e.message + '', !0) + '</pre>';
        throw e;
      }
  }
  (d.exec = d),
